...
echo encrypt...
pwd
java -cp ../server-xchroma/libs/server-1.0.jar server.FileCipher ../server_credentials/conf/xchroma/key backend/target/backend-1.0.0.jar code ../server-xchroma/apps/xchroma/libs/xchroma-encrypted.jar
